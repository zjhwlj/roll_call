    ...
    private void initView(){
        ...
        retrieve.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("你的密码是：123456"); //设置内容
        ...
        checkNumber.setOnFocusChangeListener(new android.view.View.
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    String code = checkNumber.getText().toString();
    ...
    Handler hd = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == CODE_REPEAT) {
                ...
                tt.cancel();//取消任务
                TIME = 60;//时间重置
                getCheckNumber.setText("重新发送验证码");
            } else {
                getCheckNumber.setText(TIME + "s重新发送验证码");
            }
        }
    };
    //回调
    ...
    private void alterWarning() {        //构造器
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ForgetPassword.this, "已发送" + which, Toast.LENGTH_SHORT).show();
                tm = new Timer();
                tt = new TimerTask() {
                    @Override
                    public void run() {
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() { //设置取消按钮
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(ForgetPassword.this, "已取消" + which, Toast.LENGTH_SHORT).show();
            }
        });
        //参数都设置完成了，创建并显示出来
        builder.create().show();
