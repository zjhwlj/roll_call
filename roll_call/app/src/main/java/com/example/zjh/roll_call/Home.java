...
public class Home extends Activity {//implements ImageUtil.CropHandler
...
//        setContentView(R.layout.home);
       ...
       btn.setOnClickListener(new View.OnClickListener() {
        ...
        initNotice();
        NoticeAdapter adapter = new NoticeAdapter(Home.this,
            ...
            public void onItemClick(AdapterView<?> parent, View view,
             ...
             /*   Notice notice = noticeList.get(position);
                Toast.makeText(Home.this, notice.getName(),
                        Toast.LENGTH_SHORT).show();*/
                Intent i = new Intent(Home.this, Sign.class);
                startActivity(i);
            }
        });
        addcourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Home.this, AddCourse.class);
                startActivity(i);
            }
        });
...
//        });
    ...
    private void initNotice(){
        Notice course = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course);
        Notice course1 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course1);
        ...
        Notice course8 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course8);
        Notice course9 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course9);
        Notice course10 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course10);
        Notice course11 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course11);
        Notice course12 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course12);
        Notice course13 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course13);
        Notice course14 = new Notice("Apple", "陈xx",21312312);
        noticeList.add(course14);
    }
